...
class Cursor(object):
    ...
    _query_class = ...
    _getmore_class = ...
    def __init__(self, collection, filter: Optional[Any] = ..., projection: Optional[Any] = ..., skip=..., limit=..., no_cursor_timeout: bool = ..., cursor_type=..., sort: Optional[Any] = ..., allow_partial_results: bool = ..., oplog_replay: bool = ..., modifiers: Optional[Any] = ..., batch_size=..., manipulate: bool = ..., collation: Optional[Any] = ..., hint: Optional[Any] = ..., max_scan: Optional[Any] = ..., max_time_ms: Optional[Any] = ..., max: Optional[Any] = ..., min: Optional[Any] = ..., return_key: bool = ..., show_record_id: bool = ..., snapshot: bool = ..., comment: Optional[Any] = ..., session: Optional[Any] = ...):
        """Create a new cursor.
    ...
    def _clone(self, deepcopy: bool = ..., base: Optional[Any] = ...):
    ...
    def sort(self, key_or_list, direction: Optional[Any] = ...):
    ...
    def _deepcopy(self, x, memo: Optional[Any] = ...):
