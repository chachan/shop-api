...
class Collation(object):
    ...
    """
    __slots__ = ...
    def __init__(self, locale, caseLevel: Optional[Any] = ..., caseFirst: Optional[Any] = ..., strength: Optional[Any] = ..., numericOrdering: Optional[Any] = ..., alternate: Optional[Any] = ..., maxVariable: Optional[Any] = ..., normalization: Optional[Any] = ..., backwards: Optional[Any] = ..., **kwargs):
        ...
