...
class AutoEncryptionOpts(object):
    ...
    def __init__(self, kms_providers, key_vault_namespace, key_vault_client: Optional[Any] = ..., schema_map: Optional[Any] = ..., bypass_auto_encryption: bool = ..., mongocryptd_uri=..., mongocryptd_bypass_spawn: bool = ..., mongocryptd_spawn_path=..., mongocryptd_spawn_args: Optional[Any] = ...):
        """Options to configure automatic client-side field level encryption.
