...
class ClientEncryption(object):
    ...
    def create_data_key(self, kms_provider, master_key: Optional[Any] = ..., key_alt_names: Optional[Any] = ...):
    ...
    def encrypt(self, value, algorithm, key_id: Optional[Any] = ..., key_alt_name: Optional[Any] = ...):
