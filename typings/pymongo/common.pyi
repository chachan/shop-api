...
from bson.binary import CSHARP_LEGACY, JAVA_LEGACY, PYTHON_LEGACY, STANDARD
...
_UUID_REPRESENTATIONS = { 'standard': STANDARD,'pythonLegacy': PYTHON_LEGACY,'javaLegacy': JAVA_LEGACY,'csharpLegacy': CSHARP_LEGACY }
...
_MECHANISM_PROPS = frozenset(['SERVICE_NAME', 'CANONICALIZE_HOST_NAME', 'SERVICE_REALM'])
...
INTERNAL_URI_OPTION_NAME_MAP = { 'j': 'journal','wtimeout': 'wtimeoutms','tls': 'ssl','tlsallowinvalidcertificates': 'ssl_cert_reqs','tlsallowinvalidhostnames': 'ssl_match_hostname','tlscrlfile': 'ssl_crlfile','tlscafile': 'ssl_ca_certs','tlscertificatekeyfile': 'ssl_certfile','tlscertificatekeyfilepassword': 'ssl_pem_passphrase' }
...
def get_validated_options(options, warn: bool = ...):
