...
class Database(common.BaseObject):
    """A Mongo database.
    """
    def __init__(self, client, name, codec_options: Optional[Any] = ..., read_preference: Optional[Any] = ..., write_concern: Optional[Any] = ..., read_concern: Optional[Any] = ...):
    ...
    def get_collection(self, name, codec_options: Optional[Any] = ..., read_preference: Optional[Any] = ..., write_concern: Optional[Any] = ..., read_concern: Optional[Any] = ...):
    ...
    def create_collection(self, name, codec_options: Optional[Any] = ..., read_preference: Optional[Any] = ..., write_concern: Optional[Any] = ..., read_concern: Optional[Any] = ..., session: Optional[Any] = ..., **kwargs):
    ...
    def _command(self, sock_info, command, slave_ok: bool = ..., value=..., check: bool = ..., allowable_errors: Optional[Any] = ..., read_preference=..., codec_options=..., write_concern: Optional[Any] = ..., parse_write_concern_error: bool = ..., session: Optional[Any] = ..., **kwargs):
        """Internal command helper."""
        ...
    
    def command(self, command, value=..., check: bool = ..., allowable_errors: Optional[Any] = ..., read_preference: Optional[Any] = ..., codec_options=..., session: Optional[Any] = ..., **kwargs):
    ...
    def _retryable_read_command(self, command, value=..., check: bool = ..., allowable_errors: Optional[Any] = ..., read_preference: Optional[Any] = ..., codec_options=..., session: Optional[Any] = ..., **kwargs):
    ...
    def list_collections(self, session: Optional[Any] = ..., filter: Optional[Any] = ..., **kwargs):
    ...
    def list_collection_names(self, session: Optional[Any] = ..., filter: Optional[Any] = ..., **kwargs):
    ...
    def drop_collection(self, name_or_collection, session: Optional[Any] = ...):
        """Drop a collection.
    ...
    def validate_collection(self, name_or_collection, scandata: bool = ..., full: bool = ..., session: Optional[Any] = ...):
    ...
    def _current_op(self, include_all: bool = ..., session: Optional[Any] = ...):
    ...
    def set_profiling_level(self, level, slow_ms: Optional[Any] = ..., session: Optional[Any] = ...):
    ...
    def _create_or_update_user(self, create, name, password, read_only, session: Optional[Any] = ..., **kwargs):
        """Use a command to create (if create=True) or modify a user.
        """
        ...
    
    def add_user(self, name, password: Optional[Any] = ..., read_only: Optional[Any] = ..., session: Optional[Any] = ..., **kwargs):
    ...
    def remove_user(self, name, session: Optional[Any] = ...):
    ...
    def authenticate(self, name: Optional[Any] = ..., password: Optional[Any] = ..., source: Optional[Any] = ..., mechanism=..., **kwargs):
    ...
    def dereference(self, dbref, session: Optional[Any] = ..., **kwargs):
