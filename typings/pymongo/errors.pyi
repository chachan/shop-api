...
class PyMongoError(Exception):
    ...
    def __init__(self, message=..., error_labels: Optional[Any] = ...):
        ...
...
class AutoReconnect(ConnectionFailure):
    ...
    """
    def __init__(self, message=..., errors: Optional[Any] = ...):
        self.errors = ...
...
class OperationFailure(PyMongoError):
    ...
    """
    def __init__(self, error, code: Optional[Any] = ..., details: Optional[Any] = ...):
        ...
