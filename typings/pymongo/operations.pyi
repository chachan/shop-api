...
class DeleteOne(object):
    ...
    __slots__ = ...
    def __init__(self, filter, collation: Optional[Any] = ...):
...
class ReplaceOne(object):
    ...
    __slots__ = ...
    def __init__(self, filter, replacement, upsert: bool = ..., collation: Optional[Any] = ...):
...
class UpdateOne(_UpdateOp):
    ...
    __slots__ = ...
    def __init__(self, filter, update, upsert: bool = ..., collation: Optional[Any] = ..., array_filters: Optional[Any] = ...):
        """Represents an update_one operation.
