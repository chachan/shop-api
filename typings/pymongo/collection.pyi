...
class Collection(common.BaseObject):
    """A Mongo collection.
    """
    def __init__(self, database, name, create: bool = ..., codec_options: Optional[Any] = ..., read_preference: Optional[Any] = ..., write_concern: Optional[Any] = ..., read_concern: Optional[Any] = ..., session: Optional[Any] = ..., **kwargs):
    ...
    def _command(self, sock_info, command, slave_ok: bool = ..., read_preference: Optional[Any] = ..., codec_options: Optional[Any] = ..., check: bool = ..., allowable_errors: Optional[Any] = ..., read_concern: Optional[Any] = ..., write_concern: Optional[Any] = ..., collation: Optional[Any] = ..., session: Optional[Any] = ..., retryable_write: bool = ..., user_fields: Optional[Any] = ...):
    ...
    def bulk_write(self, requests, ordered: bool = ..., bypass_document_validation: bool = ..., session: Optional[Any] = ...):
    ...
    def _insert(self, docs, ordered: bool = ..., check_keys: bool = ..., manipulate: bool = ..., write_concern: Optional[Any] = ..., op_id: Optional[Any] = ..., bypass_doc_val: bool = ..., session: Optional[Any] = ...):
        """Internal insert helper."""
        ...
    
    def insert_one(self, document, bypass_document_validation: bool = ..., session: Optional[Any] = ...):
    ...
    def insert_many(self, documents, ordered: bool = ..., bypass_document_validation: bool = ..., session: Optional[Any] = ...):
    ...
    def _update(self, sock_info, criteria, document, upsert: bool = ..., check_keys: bool = ..., multi: bool = ..., manipulate: bool = ..., write_concern: Optional[Any] = ..., op_id: Optional[Any] = ..., ordered: bool = ..., bypass_doc_val: bool = ..., collation: Optional[Any] = ..., array_filters: Optional[Any] = ..., session: Optional[Any] = ..., retryable_write: bool = ...):
        """Internal update / replace helper."""
        ...
    
    def _update_retryable(self, criteria, document, upsert: bool = ..., check_keys: bool = ..., multi: bool = ..., manipulate: bool = ..., write_concern: Optional[Any] = ..., op_id: Optional[Any] = ..., ordered: bool = ..., bypass_doc_val: bool = ..., collation: Optional[Any] = ..., array_filters: Optional[Any] = ..., session: Optional[Any] = ...):
        """Internal update / replace helper."""
        ...
    
    def replace_one(self, filter, replacement, upsert: bool = ..., bypass_document_validation: bool = ..., collation: Optional[Any] = ..., session: Optional[Any] = ...):
    ...
    def update_one(self, filter, update, upsert: bool = ..., bypass_document_validation: bool = ..., collation: Optional[Any] = ..., array_filters: Optional[Any] = ..., session: Optional[Any] = ...):
    ...
    def update_many(self, filter, update, upsert: bool = ..., array_filters: Optional[Any] = ..., bypass_document_validation: bool = ..., collation: Optional[Any] = ..., session: Optional[Any] = ...):
    ...
    def drop(self, session: Optional[Any] = ...):
    ...
    def _delete(self, sock_info, criteria, multi, write_concern: Optional[Any] = ..., op_id: Optional[Any] = ..., ordered: bool = ..., collation: Optional[Any] = ..., session: Optional[Any] = ..., retryable_write: bool = ...):
        """Internal delete helper."""
        ...
    
    def _delete_retryable(self, criteria, multi, write_concern: Optional[Any] = ..., op_id: Optional[Any] = ..., ordered: bool = ..., collation: Optional[Any] = ..., session: Optional[Any] = ...):
        """Internal delete helper."""
        ...
    
    def delete_one(self, filter, collation: Optional[Any] = ..., session: Optional[Any] = ...):
    ...
    def delete_many(self, filter, collation: Optional[Any] = ..., session: Optional[Any] = ...):
    ...
    def find_one(self, filter: Optional[Any] = ..., *args, **kwargs):
    ...
    def parallel_scan(self, num_cursors, session: Optional[Any] = ..., **kwargs):
    ...
    def _count(self, cmd, collation: Optional[Any] = ..., session: Optional[Any] = ...):
        """Internal count helper."""
        ...
    
    def _aggregate_one_result(self, sock_info, slave_ok, cmd, collation: Optional[Any] = ..., session: Optional[Any] = ...):
    ...
    def count_documents(self, filter, session: Optional[Any] = ..., **kwargs):
    ...
    def count(self, filter: Optional[Any] = ..., session: Optional[Any] = ..., **kwargs):
    ...
    def create_indexes(self, indexes, session: Optional[Any] = ..., **kwargs):
    ...
    def create_index(self, keys, session: Optional[Any] = ..., **kwargs):
    ...
    def drop_indexes(self, session: Optional[Any] = ..., **kwargs):
    ...
    def drop_index(self, index_or_name, session: Optional[Any] = ..., **kwargs):
    ...
    def reindex(self, session: Optional[Any] = ..., **kwargs):
    ...
    def aggregate(self, pipeline, session: Optional[Any] = ..., **kwargs):
    ...
    def group(self, key, condition, initial, reduce, finalize: Optional[Any] = ..., **kwargs):
    ...
    def rename(self, new_name, session: Optional[Any] = ..., **kwargs):
    ...
    def distinct(self, key, filter: Optional[Any] = ..., session: Optional[Any] = ..., **kwargs):
    ...
    def map_reduce(self, map, reduce, out, full_response: bool = ..., session: Optional[Any] = ..., **kwargs):
    ...
    def inline_map_reduce(self, map, reduce, full_response: bool = ..., session: Optional[Any] = ..., **kwargs):
    ...
    def __find_and_modify(self, filter, projection, sort, upsert: Optional[Any] = ..., return_document: bool = ..., array_filters: Optional[Any] = ..., session: Optional[Any] = ..., **kwargs):
        """Internal findAndModify helper."""
        ...
    
    def find_one_and_delete(self, filter, projection: Optional[Any] = ..., sort: Optional[Any] = ..., session: Optional[Any] = ..., **kwargs):
    ...
    def find_one_and_replace(self, filter, replacement, projection: Optional[Any] = ..., sort: Optional[Any] = ..., upsert: bool = ..., return_document: bool = ..., session: Optional[Any] = ..., **kwargs):
    ...
    def find_one_and_update(self, filter, update, projection: Optional[Any] = ..., sort: Optional[Any] = ..., upsert: bool = ..., return_document: bool = ..., array_filters: Optional[Any] = ..., session: Optional[Any] = ..., **kwargs):
    ...
    def save(self, to_save, manipulate: bool = ..., check_keys: bool = ..., **kwargs):
    ...
    def insert(self, doc_or_docs, manipulate: bool = ..., check_keys: bool = ..., continue_on_error: bool = ..., **kwargs):
    ...
    def update(self, spec, document, upsert: bool = ..., manipulate: bool = ..., multi: bool = ..., check_keys: bool = ..., **kwargs):
    ...
    def remove(self, spec_or_id: Optional[Any] = ..., multi: bool = ..., **kwargs):
    ...
    def find_and_modify(self, query=..., update: Optional[Any] = ..., upsert: bool = ..., sort: Optional[Any] = ..., full_response: bool = ..., manipulate: bool = ..., **kwargs):
