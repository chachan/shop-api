...
_IMPLICIT_TLSINSECURE_OPTS = "tlsallowinvalidcertificates", "tlsallowinvalidhostnames"
_TLSINSECURE_EXCLUDE_OPTS = _IMPLICIT_TLSINSECURE_OPTS | INTERNAL_URI_OPTION_NAME_MAP[k] for k in _IMPLICIT_TLSINSECURE_OPTS
...
def validate_options(opts, warn: bool = ...):
...
def split_options(opts, validate: bool = ..., warn: bool = ..., normalize: bool = ...):
...
def parse_uri(uri, default_port=..., validate: bool = ..., warn: bool = ..., normalize: bool = ..., connect_timeout: Optional[Any] = ...):
