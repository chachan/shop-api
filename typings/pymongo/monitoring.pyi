...
class _EventListeners(object):
    ...
    def publish_command_start(self, command, database_name, request_id, connection_id, op_id: Optional[Any] = ...):
    ...
    def publish_command_success(self, duration, reply, command_name, request_id, connection_id, op_id: Optional[Any] = ...):
    ...
    def publish_command_failure(self, duration, failure, command_name, request_id, connection_id, op_id: Optional[Any] = ...):
